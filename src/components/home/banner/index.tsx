...
export default function Banner() {
    return (
        <section
            ...
            className="min-h-[500px] lg:min-h-[800px] px-8 xl:px-0 my-32 flex justify-center relative">
            <div
            ...
            <div className="w-full lg:max-w-[1220px] flex flex-col items-center pt-24 lg:pt-48 text-center gap-5 lg:gap-8 text-white">
                ...
                {/* <!-- Sub title --> */}
                <h1 className="lg:w-5/6 text-[50px] lg:text-[100px] xl:text-[130px] text-center leading-32">INTO SPECTACULAR</h1>
            </div>
        </section>
