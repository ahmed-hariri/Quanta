...
export default function Banner2() {
    return (
        <section
            className="min-h-[500px] lg:h-[1010px] xl:max-h-[1100px] px-8 xl:px-0 lg:mt-32 flex justify-center relative bg-gradient-to-b from-[#05050555] to-[#000000]/50 lg:to-[#000000]">
